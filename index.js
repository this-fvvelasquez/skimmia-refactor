...
function countNumbers() {
    for (var counter = INITS_AT; counter <= ENDS_AT; counter++) {
...
function countMultiplesOf(specialPrint, MULTIPLE_OF) {
    // ----------------------------
    var multiplesOf = [];
    var multiple;
    var i;
    // ----------------------------
    for (multiple = MULTIPLE_OF, i = 1; multiple <= ENDS_AT; multiple = MULTIPLE_OF * ++i) {
...
function countMultiplesOfBoth(specialPrint, multiplesOf_A, multiplesOf_B) {
    // ----------------------------
    var multiple;
    var i, j;
    // ----------------------------
...
var mOf_3 = countMultiplesOf("Music", 3);
// ----------------------------
// Insertamos "TI" en lugar de cada multiplo de 5.
var mOf_5 = countMultiplesOf("TI", 5);
// ----------------------------
